<template>
    <section class="py-[298px] overflow-x-clip lg:pt-[273px] lg:pb-[200px]">
        <div class="flex relative w-full max-w-[576px] mx-auto lg:max-w-[68.5rem] px-4 lg:px-16 xl:px-0">
            <!-- content -->
            ...
            <div class="absolute -top-[135px] left-1/2 -translate-x-1/2 w-[460px] h-[713px] blur-[80px] overflow-hidden lg:hidden">
                ...
                <div class="absolute top-0 left-[106px]">
                    <div class="absolute top-0 left-[24px]">
                        <BlurUnit class="blur-[100px]"/>
                    </div>
                    <div class="absolute top-[51px] left-0">
                ...
                <div class="absolute top-[225px] left-[46px]">
                    <div class="absolute top-0 left-[24px]">
                        <BlurUnit class="blur-[100px]"/>
                    </div>
                    <div class="absolute top-[51px] left-0">
